...
// eslint-disable-next-line
import {goPage, nextPage, prevPage} from "../../actions/actions";
...
class Pagination extends Component {
    ...
    render() {
        ...
        const pages =this.getPages().map(pageNum => {
            ...
            return (<li className={buttonClass} key={pageNum} onClick={() => {this.onPage(pageNum)}}><button className="page-link" >{pageNum}</button></li>);
        });
